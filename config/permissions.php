    ...
    */
    'role_defaults' => [
        ...
        'MOZO' => [
            ...
            'kitchen.view' => false,
            'cash-register.view' => true, 'cash-register.create' => false, 'cash-register.update' => false, 'cash-register.delete' => false,
            'discount-types.view' => false,
            'sectors.view' => false, 'categories.view' => false,
            'products.view' => true,
            'stock.view' => true, 'stock.create' => true, 'stock.update' => false, 'stock.delete' => false,
            'stock_mozo.create' => false,
            'users.view' => false, 'printers.view' => false,
