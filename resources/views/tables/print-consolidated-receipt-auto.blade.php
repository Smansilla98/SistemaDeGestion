...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .border-asterisk { text-align: center; font-size: 8px; letter-spacing: 0.5px; margin: 2px 0; }
        .header { text-align: center; margin-bottom: 3px; }
        .logo-container { text-align: center; margin-bottom: 2px; }
        .logo-container img { max-width: 40mm; max-height: 15mm; object-fit: contain; }
        .header h1 { font-size: 12px; font-weight: bold; margin: 2px 0; text-transform: uppercase; }
        .header-info { display: flex; justify-content: space-between; font-size: 7px; margin: 2px 0; }
        .dashed-line { border-top: 1px dashed #000; margin: 2px 0; }
        .order-info { margin-bottom: 3px; font-size: 8px; }
        .order-info p { margin: 1px 0; line-height: 1.1; }
        .items { margin: 3px 0; }
        .item { margin-bottom: 2px; padding-bottom: 1px; }
        .item-line { display: flex; justify-content: space-between; font-size: 8px; line-height: 1.1; }
        .item-quantity { margin-right: 3px; font-weight: bold; min-width: 15px; }
        .item-name { flex: 1; word-break: break-word; }
        .item-price { text-align: right; min-width: 35px; font-weight: bold; }
        .totals { margin-top: 3px; padding-top: 2px; }
        .total-line { display: flex; justify-content: space-between; margin: 1px 0; font-size: 8px; }
        .total-line.final { font-weight: bold; font-size: 10px; border-top: 1px dashed #000; padding-top: 2px; margin-top: 2px; }
        .payments { margin-top: 3px; padding-top: 2px; border-top: 1px dashed #000; font-size: 8px; }
        .payment-line { display: flex; justify-content: space-between; margin: 1px 0; font-size: 8px; }
        .payment-total { border-top: 1px dashed #000; padding-top: 2px; margin-top: 2px; font-weight: bold; }
        .change-line { display: flex; justify-content: space-between; margin: 1px 0; font-size: 8px; }
        .footer { margin-top: 4px; text-align: center; border-top: 1px dashed #000; padding-top: 2px; font-size: 7px; }
        .thank-you { text-align: center; font-weight: bold; margin: 2px 0; font-size: 9px; }
        .barcode-placeholder { text-align: center; margin-top: 3px; font-size: 7px; color: #666; }
        .orders-info { margin-top: 3px; padding-top: 2px; border-top: 1px dashed #000; font-size: 7px; color: #666; }

        @media print {
            html, body { margin: 0 !important; padding: 0 !important; width: 58mm !important; max-width: 58mm !important; overflow: visible !important; }
        }
    </style>
</head>
<body>
    ...
    <div class="payments">
        ...
        @if($payment->operation_number ?? null)
