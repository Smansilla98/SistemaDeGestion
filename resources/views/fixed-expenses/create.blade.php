                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" 
                            ...
                            <option value="ALQUILER" {{ old('category') == 'ALQUILER' ? 'selected' : '' }}>Alquiler</option>
                            ...
                            <option value="OPERATIVOS" {{ old('category') == 'OPERATIVOS' ? 'selected' : '' }}>Operativos</option>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('frequency') is-invalid @enderror" 
                            ...
                            <option value="ANUAL" {{ old('frequency') == 'ANUAL' ? 'selected' : '' }}>Anual</option>
                        </select>
                        @error('frequency')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
