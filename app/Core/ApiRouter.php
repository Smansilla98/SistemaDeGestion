...
final class ApiRouter
{
    ...
    public static function sharedRestRoutes(): array
    {
        ...
        return [
            ...
            ['methods' => ['POST'], 'uri' => 'orders/{id}/items/replace', 'action' => [OrderOpsController::class, 'replaceItem'], 'middleware' => array_merge($jwt, ['permission:orders.write'])],
            ...
            ['methods' => ['POST'], 'uri' => 'orders/{id}/close', 'action' => [OrderOpsController::class, 'close'], 'middleware' => array_merge($jwt, ['permission:orders.write'])],
            ...
            ['methods' => ['POST'], 'uri' => 'tables', 'action' => [TableOpsController::class, 'store'], 'middleware' => array_merge($jwt, ['permission:tables.write'])],
            ['methods' => ['GET'], 'uri' => 'tables/layout', 'action' => [TableOpsController::class, 'layout'], 'middleware' => array_merge($jwt, ['permission:tables.read'])],
            ['methods' => ['POST'], 'uri' => 'tables/layout', 'action' => [TableOpsController::class, 'updateLayout'], 'middleware' => array_merge($jwt, ['permission:tables.write'])],
            ['methods' => ['GET'], 'uri' => 'tables/{id}', 'action' => [TableOpsController::class, 'show'], 'middleware' => array_merge($jwt, ['permission:tables.read'])],
            ['methods' => ['PUT', 'PATCH'], 'uri' => 'tables/{id}', 'action' => [TableOpsController::class, 'update'], 'middleware' => array_merge($jwt, ['permission:tables.write'])],
            ['methods' => ['DELETE'], 'uri' => 'tables/{id}', 'action' => [TableOpsController::class, 'destroy'], 'middleware' => array_merge($jwt, ['permission:tables.write'])],
            ['methods' => ['POST'], 'uri' => 'tables/{id}/reserve', 'action' => [TableOpsController::class, 'reserve'], 'middleware' => array_merge($jwt, ['permission:tables.write'])],
            ...
            ['methods' => ['GET'], 'uri' => 'permissions/modules', 'action' => [PermissionOpsController::class, 'modules'], 'middleware' => array_merge($jwt, ['permission:users.read'])],
            ['methods' => ['GET'], 'uri' => 'permissions/users/{id}/matrix', 'action' => [PermissionOpsController::class, 'userMatrix'], 'middleware' => array_merge($jwt, ['permission:users.read'])],
            ['methods' => ['POST'], 'uri' => 'permissions/user', 'action' => [PermissionOpsController::class, 'updateUser'], 'middleware' => array_merge($jwt, ['permission:users.write'])],
            ['methods' => ['POST'], 'uri' => 'permissions/role', 'action' => [PermissionOpsController::class, 'updateRole'], 'middleware' => array_merge($jwt, ['permission:users.write'])],
            ...
            ['methods' => ['POST'], 'uri' => 'cash/registers', 'action' => [CashOpsController::class, 'storeRegister'], 'middleware' => array_merge($jwt, ['permission:cash.write'])],
            ['methods' => ['PUT', 'PATCH'], 'uri' => 'cash/registers/{id}', 'action' => [CashOpsController::class, 'updateRegister'], 'middleware' => array_merge($jwt, ['permission:cash.write'])],
            ['methods' => ['DELETE'], 'uri' => 'cash/registers/{id}', 'action' => [CashOpsController::class, 'destroyRegister'], 'middleware' => array_merge($jwt, ['permission:cash.write'])],
            ...
            ['methods' => ['GET'], 'uri' => 'stock/mozo-insumos', 'action' => [StockOpsController::class, 'mozoInsumos'], 'middleware' => array_merge($jwt, ['permission:stock_mozo.create,stock.write'])],
            ['methods' => ['POST'], 'uri' => 'stock/mozo-insumos', 'action' => [StockOpsController::class, 'storeMozoInsumo'], 'middleware' => array_merge($jwt, ['permission:stock_mozo.create,stock.write'])],
    ...
    public static function adminUserRestRoutes(): array
    {
        ...
        return [
            ...
            ['methods' => ['POST'], 'uri' => 'users/{id}/reset-password', 'action' => [UserController::class, 'resetTemporaryPassword'], 'middleware' => array_merge($jwt, ['permission:users.write'])],
